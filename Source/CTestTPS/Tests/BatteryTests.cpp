...
#include "CTestTPS/Tests/BatteryTests.h"
#include "CoreMinimal.h"
#include "Misc/AutomationTest.h"
#include "CTestTPS/Items/Battery.h"
...
bool FBatteryTests::RunTest(const FString& Parameters)
{
    ...
    TestTrueExpr(FMath::IsNearlyEqual(BatteryObject2.GetPercent(), 1.0f));
    ...
    BatteryTestFunc(3000.2f, FColor::Green, "100%");
    BatteryTestFunc(-3000.2f, FColor::Red, "0%");
    ...
    TestNotSame("Not the same battery", BatteryHighDup, BatteryHigh);

    const Battery &BatteryHighRef= BatteryHigh;
    TestSame("The same battery", BatteryHighRef, BatteryHigh);
    return true;
}
